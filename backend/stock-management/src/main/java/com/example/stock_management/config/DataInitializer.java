...
public class DataInitializer {
  ...
  CommandLineRunner initDatabase(StockRepository stockRepository) {
    return args -> {
      ...
      appleDiv1.setAmount(new BigDecimal("7.24"));
      ...
      appleDiv2.setAmount(new BigDecimal("7.24"));
      ...
      microsoft.setQuantity(5);

      Dividend msftDiv1 = new Dividend();
      msftDiv1.setStock(microsoft);
      msftDiv1.setAmount(new BigDecimal("7.68"));
      ...
      msftDiv2.setAmount(new BigDecimal("7.68"));
      ...
      cocaCola.setSector("Consumer Goods");
      ...
      cocaCola.setQuantity(20);

      Dividend koDiv1 = new Dividend();
      koDiv1.setStock(cocaCola);
      koDiv1.setAmount(new BigDecimal("7.46"));
      ...
      koDiv2.setAmount(new BigDecimal("7.46"));
